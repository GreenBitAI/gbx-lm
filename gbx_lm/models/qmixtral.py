...
class MixtralBLockSparseTop2MLP(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        self.w1 = QuantizedLinear(self.hidden_dim, self.ffn_dim, bias=False)
        self.w2 = QuantizedLinear(self.ffn_dim, self.hidden_dim, bias=False)
        self.w3 = QuantizedLinear(self.hidden_dim, self.ffn_dim, bias=False)
